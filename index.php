...
<html>
  <head>
    <title>MOBUTU | The Online Recharge Solution in Nigeria</title>
  ...
  <body>
    ...
    <div id="templatemo_home">
      ...
      <div class="container templatemo_container">
        <div class="row lead-primary">
         <!-- Start contact bar at top-->
            <article class="col-md-12 text-right">
                <span class="label label-primary">Call: +234-(080)-Mobutu | +234-(070)69629395</span>
                <span class="label label-success">Email: support@mobutu.com</span>
                <span class="label label-info">Feedbacks: www.mobutu.com</span>
                <span class="label label-warning">24/7 365days Customer Service</span>
            </article>
        <!--End contact bar at top-->
        </div>
        <div class="row">
          <div class="col-sm-3 col-md-3">
            <div class="logo">
              <a rel="nofollow" href="index.php"><img src="images/logo.png" alt="Mobutu | Everyday Recharge Solution"></a>
            </div>
          </div>
          <div class="col-sm-9 col-md-9 templatemo_col9">
            ...
            <nav class="mainMenu">
              <ul class="nav">
                ...
                <li><a class="menu" href="app/user/index.php">Login</a></li>
                <li><a class="menu" href="app/user/register.php">Sign Up</a></li>
    ...
    <!-- end menu -->
      	<div  id="slider"  class="nivoSlider templatemo_slider">
        	<a href="#"><img src="images/slider/img_0.jpg" alt="slide 1" /></a>           	
        	<a href="#"><img src="images/slider/img_1.jpg" alt="slide 2" /></a>           	
			<a href="#"><img src="images/slider/img_2.jpg" alt="slide 3" /></a>  
            <a href="#"><img src="images/slider/img_3.jpg" alt="slide 4" /></a> 	        	
	
    	</div>
             <!--<div class="templatemo_caption">
                    <div class="templatemo_slidetitle">Mobutu Recharge All Networts</div>
                    <div class="clear"></div>
                    <h1>Mobutu Recharge <a href="http://www.onecardnigeria.com">One1Card</a> Solutions</h1>
                    <div class="clear"></div>
             		<p>Revolutionize your recharge needs with <a href="http://www.onecardnigeria.com">OneCard</a>.</p>
    	...
    	<div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12">
        	<div class="item project-post">
						<div class="templatemo_about_box">
                     	   ...
                     	   Recharge all your accounts</div>
						<div class="col-xs-12 col-sm-6 col-md-3 hover-box" >
							<div class="inner-hover-box">								
								<p><strong>Four ways to recharge!</strong> <br>Choose the one that’s most convenient for you. 
                                Use your debit or credit card on MyTopUp Nigeria to recharge up to ten accounts online in a single, secure transaction.</p>
							</div>
						</div>
					</div> 	
        </div>
        <div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12">
        	<div class="item project-post">
						<div class="templatemo_about_box">
                     	   ...
                     	   Friend and Family, No Limits</div>
						<div class="col-xs-6 col-sm-6 col-md-3 hover-box" >
							<div class="inner-hover-box">								
								<p><strong>Earn regular income</strong> <br />By selling our innovative products.

Sell via One1Card, the one card that recharges multiple services. Available in as low as N20 up till N5000 and N10000 denominations.</p>
							</div>
						</div>
					</div> 	
        </div>
        <div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12 templatemo_margintop10">
        	<div class="item project-post">
						<div class="templatemo_about_box">
                     	   ...
                     	   Mobutu OneCard Solutions</div>
						<div class="col-xs-6 col-sm-6 col-md-3 hover-box" >
							<div class="inner-hover-box">								
								<p><strong>Gain more controlled spending!</strong> <br />With OneCard ElitePlus, businesses of all sizes can recharge several accounts on customized daily schedules, track spending, set reminders and more.</p>
							</div>
						</div>
					</div> 	
        </div>
        <div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12 templatemo_margintop10">
        	<div class="item project-post">
						...
						<div class="col-xs-6 col-sm-6 col-md-3 hover-box" >
							<div class="inner-hover-box">								
								<p><strong>Your special touch!</strong> <b />
                                On customized OneCards. Our custom OneCards is your choice, and boost product sales with advertising, show support for a cause, and personalize gifts.</p>
							</div>
						</div>
					</div> 	
        </div>
    ...
    <div class="templatemo_reasonbg">
    	<h2>Reasons to choose Mobutu?</h2>
       		<p>Revolutionize your recharge needs with OneCard.</p>
   ...
   <!--Footer End-->
    ...
    <div class="templatemo_bottom">
    	<div class="container">
        	<div class="row">
            	<div class="left">Copyright © <?php echo date('Y'); ?> <a href="#">Mobutu</a> <!-- Credit: www.templatemo.com --></div>
                <div class="right">
